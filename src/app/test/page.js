                ...
                <div className="mt-8 sm:mt-16">
                  ...
                  <blockquote className="mt-6">
                    <p className="text-lg font-bold text-gray-900 font-pj">
                      “You guys rocked on the sculpture project! Thanks so much
                      for doing a great job!”
                    </p>

                    <p className="mt-2 text-base font-normal text-gray-600 font-inter">
                      Leslie Alexander • Co-Founder, Startup Week
                    </p>
                  </blockquote>
                </div>
              </div>

              <div className="xl:relative xl:col-span-1">
                <img
                  className="w-full mx-auto sm:max-w-xs lg:max-w-sm xl:max-w-lg"
