...
import { MapContainer, TileLayer, Marker, Popup, useMap } from 'react-leaflet'; // Leaflet components
...
const ChangeView = ({ center }) => {
  ...
  }, [center]); // Update view when center changes
      ...
      <div style={styles.contentContainer}>
        ...
        >
          ...
          >
            ...
            <ChangeView center={mapCenter} /> {/* Update map view */}
          </MapContainer>
        </div>
